...
fun mutableVec4Of(x: Number, y: Number, z: Number, w: Number): IMutableVector4 = IVectorFactory.factory.mutableVec4Of(x,
        y, z, w)

//IQuaternion
fun quatOf(x: Number, y: Number, z: Number, w: Number): IQuaternion = IVectorFactory.factory.quatOf(x, y, z, w)

fun mutableQuatOf(x: Number, y: Number, z: Number,
                  w: Number): IMutableQuaternion = IVectorFactory.factory.mutableQuatOf(x, y, z, w)
