...
interface IMutableVector4 : IVector4 {
    ...
    override var zi: Int get() = z.toInt(); set(i) {
        z = i
    }
    override var wi: Int get() = w.toInt(); set(i) {
        w = i
    }
    ...
    override var zf: Float get() = z.toFloat(); set(i) {
        z = i
    }
    override var wf: Float get() = w.toFloat(); set(i) {
        w = i
    }
    ...
    override var zd: Double get() = z.toDouble(); set(i) {
        z = i
    }
    override var wd: Double get() = w.toDouble(); set(i) {
        w = i
    }
}