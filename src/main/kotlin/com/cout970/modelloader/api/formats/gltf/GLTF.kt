...
data class GltfNode (
        ...
        val translation: IVector3?  = Vector3.ORIGIN,       // The node's translation along the x, y, and z axes.
...
data class GltfMaterial(
        ...
        val emissiveFactor: IVector3? = Vector3.ORIGIN,                         // The RGB components of the emissive color of the material. These values are linear. If an emissiveTexture is specified, this value is multiplied with the texel values.
