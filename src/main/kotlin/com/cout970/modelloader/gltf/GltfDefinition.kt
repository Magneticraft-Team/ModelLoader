...
/**
 * Object representation of the json definition of a gltf model
 */
object GltfDefinition {
    private val GSON = GsonBuilder()
        .registerTypeAdapter(Vector4d::class.java, Vector4Deserializer())
        .registerTypeAdapter(Vector3d::class.java, Vector3Deserializer())
        .registerTypeAdapter(Vector2d::class.java, Vector2Deserializer())
        .registerTypeAdapter(Quat4d::class.java, QuaternionDeserializer())
        .registerTypeAdapter(Matrix4d::class.java, Matrix4Deserializer())
        .create()
...
data class GltfMaterial(
        ...
        val emissiveFactor: Vector3d?                       = Vector3d(0.0, 0.0,0.0), // The RGB components of the emissive color of the material. These values are linear. If an emissiveTexture is specified, this value is multiplied with the texel values.
